...
> V1.9G 완료 상태를 기준으로 현재 코드, seed, 테스트와 handoff에서 확인된 구현만 반영했다. 미완료 복합 항목에는 부분 구현 범위를 덧붙였으며, 이 문서는 다음 milestone 로드맵을 정의하지 않는다.
...
- [ ] remaining life skills — V1.6F-H 생활 심화 seed와 V1.9C/E/F/G의 채집·낚시·수렵·재배·가공·요리·연금·항해·물물교환 onboarding/strategy pack은 반영되었으나 조련 실전 전략과 recipe/measurement/economy 심화 범위는 미완료

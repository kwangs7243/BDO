...
- summary: "쿠툼의 월드 우두머리 맥락을 검은사당·필드 우두머리와 분리한 canonical 엔터티."
- purpose: "현재 규칙, 전략, 이력을 출처와 함께 구분해 확인한다."

## Requirements

### `world-boss-kutum.context`

- seed_key: "world-boss-kutum.context"
- kind: "knowledge"
...
### `world-boss-kutum.claim.context::world-boss-guide`

- evidence_seed_key: "world-boss-kutum.claim.context::world-boss-guide"
...
- entity_id: "world-boss-kutum.context"

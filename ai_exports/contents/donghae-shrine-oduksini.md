...
- slug: "donghae-shrine-oduksini"
- name_ko: "어둑시니 (동해도 검은사당)"
- category: "combat_pve"
- status: "active"
...
- summary: "어둑시니의 동해도 검은사당 맥락을 다른 동명 우두머리와 분리한 canonical 엔터티."
- purpose: "현재 규칙, 전략, 이력을 출처와 함께 구분해 확인한다."

## Requirements

### `donghae-shrine-oduksini.context`

- seed_key: "donghae-shrine-oduksini.context"
- kind: "knowledge"
...
### `donghae-shrine-oduksini.claim.context::black-shrine-donghae-guide`

- evidence_seed_key: "donghae-shrine-oduksini.claim.context::black-shrine-donghae-guide"
...
- entity_id: "donghae-shrine-oduksini.context"

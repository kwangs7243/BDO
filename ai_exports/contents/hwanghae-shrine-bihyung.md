...
- summary: "비형랑의 황해도 5인 검은사당 맥락을 다른 동명 우두머리와 분리한 canonical 엔터티."
- purpose: "현재 규칙, 전략, 이력을 출처와 함께 구분해 확인한다."

## Requirements

### `hwanghae-shrine-bihyung.context`

- seed_key: "hwanghae-shrine-bihyung.context"
- kind: "knowledge"
...
### `hwanghae-shrine-bihyung.claim.context::black-shrine-hwanghae-guide`

- evidence_seed_key: "hwanghae-shrine-bihyung.claim.context::black-shrine-hwanghae-guide"
...
- entity_id: "hwanghae-shrine-bihyung.context"

...
- slug: "donghae-shrine-songakshi"
- name_ko: "손각시 (동해도 검은사당)"
- category: "combat_pve"
- status: "active"
...
- summary: "손각시의 동해도 검은사당 맥락을 다른 동명 우두머리와 분리한 canonical 엔터티."
- purpose: "현재 규칙, 전략, 이력을 출처와 함께 구분해 확인한다."

## Requirements

### `donghae-shrine-songakshi.context`

- seed_key: "donghae-shrine-songakshi.context"
- kind: "knowledge"
...
### `donghae-shrine-songakshi.claim.context::black-shrine-donghae-guide`

- evidence_seed_key: "donghae-shrine-songakshi.claim.context::black-shrine-donghae-guide"
...
- entity_id: "donghae-shrine-songakshi.context"

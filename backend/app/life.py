...
LIFE_SKILLS = (
    LifeSkillPresentation(
        ...
        getting_started=("gathering-current-system", "gathering-onboarding-strategy"),
    ...
    LifeSkillPresentation(
        ...
        getting_started=("fishing-current-system", "fishing-onboarding-strategy"),
    ...
    LifeSkillPresentation(
        ...
        foundation_contents=("life-family-levels", "life-mastery-foundation", "energy-foundation"),
        getting_started=("farming-current-cycle", "farming-onboarding-strategy"),
    ...
    LifeSkillPresentation(
        ...
        foundation_contents=("life-family-levels", "life-mastery-foundation"),
        getting_started=("processing-current-system", "processing-onboarding-strategy"),
    ...
    LifeSkillPresentation(
        ...
        foundation_contents=("life-family-levels", "life-mastery-foundation", "energy-foundation"),
        getting_started=("hunting-current-system", "hunting-onboarding-strategy"),

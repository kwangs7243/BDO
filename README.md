...
현재 구현 milestone은 **V1.9N — Canonical Knowledge Read Interface**다.
...
- 테스트: backend 353 passed / frontend 57 passed
...
1. **Canonical knowledge** — Content/Requirement/Step/Reward/Relation, Schedule/reset, Source/Evidence, knowledge roles, historical/superseded, Project canonical requirements and deterministic calculations. V1.9N의 read-only 서비스가 이 계층을 검색하고 personal state 없는 Content/Project DTO로 투영한다.
...
2026-09-09 기준 backend 테스트는 353 passed, frontend 테스트는 57 passed다.
